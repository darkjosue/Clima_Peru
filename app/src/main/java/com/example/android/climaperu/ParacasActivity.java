...
public class ParacasActivity extends AppCompatActivity {
    ...
    private static final String REQUEST_URL =
            "http://api.openweathermap.org/data/2.5/forecast?id=3933058&APPID=77ceef6c40769b0d4fae12c45e6342b3";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, ArrayList<Clima>> {
        ...
        protected void onPostExecute(ArrayList<Clima> climas) {
            ...
            //updateUi(earthquake);
            ClimaAdapter adapter = new ClimaAdapter(ParacasActivity.this,climas);
